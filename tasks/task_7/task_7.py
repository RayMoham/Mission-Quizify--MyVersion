...
class QuizGenerator:
    ...
    def generate_question_with_vectorstore(self):
       ...
       # context = " ".join([doc[str['page_content']] for doc in context_documents])
...
if __name__ == "__main__":
    ...
    with screen.container():
        ...
        embedding_client = EmbeddingClient(embed_config["model_name"], embed_config["project"], embed_config["location"]) # Initialize from Task 4
